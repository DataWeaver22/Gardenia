...
@Entity
@Table(name="rawmaterialsimported")
public class RawMaterialsImported {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	
	@Column(name = "raw_materials_imported_id", length = 20)
	private Long raw_materials_imported_id;
	
	@Column(name = "raw_materials_imported_name", length = 20)
	private String raw_materials_imported_name;
	...
	public Long getRaw_materials_imported_id() {
		return raw_materials_imported_id;
	}

	public void setRaw_materials_imported_id(Long raw_materials_imported_id) {
		this.raw_materials_imported_id = raw_materials_imported_id;
	}

	public String getRaw_materials_imported_name() {
		return raw_materials_imported_name;
	}

	public void setRaw_materials_imported_name(String raw_materials_imported_name) {
		this.raw_materials_imported_name = raw_materials_imported_name;
	}
	...
	public RawMaterialsImported(Long raw_materials_imported_id, String raw_materials_imported_name, String previous_5th_year,

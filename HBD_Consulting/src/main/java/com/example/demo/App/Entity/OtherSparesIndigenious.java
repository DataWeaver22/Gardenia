...
@Entity
@Table(name="othersparesindigenious")
public class OtherSparesIndigenious {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	
	@Column(name = "other_spares_indigeneous_id", length = 20)
	private Long other_spares_indigeneous_id;
	
	@Column(name = "other_spares_indigeneous_name", length = 20)
	private String other_spares_indigeneous_name;
	...
	public Long getOther_spares_indigeneous_id() {
		return other_spares_indigeneous_id;
	}

	public void setOther_spares_indigeneous_id(Long other_spares_indigeneous_id) {
		this.other_spares_indigeneous_id = other_spares_indigeneous_id;
	}

	public String getOther_spares_indigeneous_name() {
		return other_spares_indigeneous_name;
	}

	public void setOther_spares_indigeneous_name(String other_spares_indigeneous_name) {
		this.other_spares_indigeneous_name = other_spares_indigeneous_name;
	}
	...
	public OtherSparesIndigenious(Long other_spares_indigeneous_id, String other_spares_indigeneous_name, String previous_5th_year,

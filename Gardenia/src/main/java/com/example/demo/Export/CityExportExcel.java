...
public class CityExportExcel {
    ...
    private List<City> listUsers;
     
    public CityExportExcel(List<City> listUsers) {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 2, "City Code", style);
        createCell(row, 3, "District Name", style);   
        createCell(row, 4, "District Code", style);
